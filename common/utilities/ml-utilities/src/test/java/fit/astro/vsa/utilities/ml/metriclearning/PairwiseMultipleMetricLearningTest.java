 ...
 */
public class PairwiseMultipleMetricLearningTest {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(PairwiseMultipleMetricLearningTest.class);

    private final Random RAND = new Random(42L);

    public PairwiseMultipleMetricLearningTest() {
    }
    ...
    @Test
    public void testPMML() throws IOException, NotEnoughDataException {
