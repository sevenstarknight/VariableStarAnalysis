 ...
 */
public class LargeMarginNearestNeighborTest {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(LargeMarginNearestNeighborTest.class);

    private final Random RAND = new Random(42L);

    public LargeMarginNearestNeighborTest() {
    }
    ...
    public void testLMNN() throws IOException, NotEnoughDataException {
        ...
        LargeMarginNearestNeighbor lmnn
                = new LargeMarginNearestNeighbor(
                        ...
                        crossDataLMNN.getSetOfTrainingClasses(), 10);
