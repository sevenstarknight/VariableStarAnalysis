...
import fit.astro.vsa.utilities.ml.metriclearning.sj.SJLearning;
 ...
 */
public class SJMetricLearningTest {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(SJMetricLearningTest.class);

    private final Random RAND = new Random(42L);

    public SJMetricLearningTest() {
    }
    ...
    public void testMetricLearning() throws IOException, NotEnoughDataException {
        ...
        //===================================================================
        // Try S&J
        SJLearning sjlearning = new SJLearning(
                        crossData.getSetOfTrainingPatterns(),
                        crossData.getSetOfTrainingClasses());

        RealMatrix mk = sjlearning.generateMetric();
