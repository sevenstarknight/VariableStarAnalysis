 ...
 * @author kjohnston
 */
public class ProcessRawkNN {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(ProcessRawkNN.class);
    ...
    protected static void trainKNN()
        ...
        MatlabFunctions.storeToFinal("Train-kNN-Vector", list);
    }
    ...
    protected static void testKNN(int kNeig) throws IOException, NotEnoughDataException {
        ...
        //===================================================================
        // Try NCA
        LOGGER.info("With kNN, k-NN: " + kNeig);
        ...
        MatlabFunctions.storeToFinal("Test-kNN-SingleView-Vector", list);
