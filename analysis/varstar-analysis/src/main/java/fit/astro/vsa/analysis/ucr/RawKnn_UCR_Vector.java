 ...
 * @author kjohnston
 */
public class RawKnn_UCR_Vector extends ProcessRawMultiViewKNN{

    private static final Random RAND = new Random(42L);

    private static final Logger LOGGER
            = LoggerFactory.getLogger(RawKnn_UCR_Vector.class);
     ...
     */
    public static void execute(int kValue, boolean isTest, String inputLocation)
