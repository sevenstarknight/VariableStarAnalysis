 ...
 */
public class ProcessLINEARDataViaL3ML extends ProcessTimeDomainViaL3ML {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(ProcessLINEARDataViaL3ML.class);
    ...
    public static void execute(double tau, double mu, double lambda, boolean isTest, String fileLocation)
        ...
        // =================================================================
        if (!isTest) {
            trainL3ML("Vector_LINEAR_" + String.valueOf(tau)
                    + "_" + String.valueOf(mu) + "_" + String.valueOf(lambda) + ".mat",
                    tau, mu, lambda);
        } else {
            testL3ML(13, tau, mu, lambda, "Vector_LINEAR.mat");
        }
    }
