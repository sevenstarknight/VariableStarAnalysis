 ...
 */
public class ProcessLINEARDataViakNN extends ProcessRawkNN {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(ProcessLINEARDataViakNN.class);
    ...
    private static final String dataLocations = "/datasets/dataLINEAR_NoECVA.ser";
