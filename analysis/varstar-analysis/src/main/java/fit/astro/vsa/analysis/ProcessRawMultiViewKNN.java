 ...
 * @author kjohnston
 */
public class ProcessRawMultiViewKNN {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(ProcessRawMultiViewKNN.class);
    ...
    protected static void trainKNN(String dataset)
        ...
        MatlabFunctions.storeToFinal("Train-KNN-MultiView-Vector" + dataset, list);
    }
    ...
    protected static void testKNN(int kNeig, String dataset) throws IOException, NotEnoughDataException {
        ...
        MatlabFunctions.storeToFinal("Test-KNN-MultiView-Vector" + dataset, list);
