 ...
 * @author kjohnston
 */
public class ProcessRawNCA {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(ProcessRawNCA.class);
    ...
    protected static void trainKNN()
        ...
        MatlabFunctions.storeToFinal("Train-NCA-MultiView-Vector", list);
    }
    ...
    protected static void testKNN(int kNeig) throws IOException, NotEnoughDataException {
        ...
        //===================================================================
        // Try NCA
        LOGGER.info("With NCA MultiView, k-NN: " + kNeig);
        ...
        MatlabFunctions.storeToFinal("Test-NCA-SingleView-Vector", list);
