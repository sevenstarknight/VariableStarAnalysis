 ...
 */
public class SSMMMetricLearningTest {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(SSMMMetricLearningTest.class);

    private Random RAND = new Random(42L);

    public SSMMMetricLearningTest() {
    }
    ...
    public void setUp() throws IOException, URISyntaxException {
        ...
        double windowWidth = SSMMGenerator.estimateWindowWidth(
                trainingData.getSetOfWaveforms().values().iterator().next(), 1);

        SSMMGenerator ssmmGenerator
                = new SSMMGenerator(0.18, windowWidth);
    ...
    public void testNCA() throws IOException, NotEnoughDataException {
        ...
        LOGGER.info("===========================================");
//        ConfusionMatrix confusionMatrixWithout
//                = new ConfusionMatrix(setOfClasses, knnWithoutResults);
//
//        confusionMatrixWithout.printConfusionMatrix();
//
//        ConfusionMatrix confusionMatrixWith
//                = new ConfusionMatrix(setOfClasses, knnWithResults);
//
//        confusionMatrixWith.printConfusionMatrix();
    }
